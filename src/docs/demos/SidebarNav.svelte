<div class="stack">
  <nav class="sidebar-nav" aria-label="Workspace sidebar">
    ...
    <p class="sidebar-nav-heading">Planning</p>
    <details open>
      <summary>
        <svg viewBox="0 0 20 20" fill="currentColor">
      ...
      <a href="#upcoming" aria-current="page">Upcoming</a>
      <a href="#past">Past</a>
    </details>
    <details>
      <summary>
    ...
    <p class="sidebar-nav-heading">Account</p>
    <a href="#settings">
      <svg viewBox="0 0 20 20" fill="currentColor">
        <circle
          cx="10"
