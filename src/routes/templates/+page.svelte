	...
	<div class="layout-card" style="--layout-min-card-width: 300px;">
		...
		<article class="card">
			<div class="card-body stack" style="--gap: var(--vs-m);">
				...
				<div class="cluster" style="--gap: var(--vs-xs);">
					<span class="chip">Hero</span>
					<span class="chip">Social Proof</span>
					<span class="chip">Feature Grid</span>
		...
		<article class="card">
			<div class="card-body stack" style="--gap: var(--vs-m);">
				...
				<div class="cluster" style="--gap: var(--vs-xs);">
					...
					<span class="chip">Stat Cards</span>
		...
		<article class="card">
			<div class="card-body stack" style="--gap: var(--vs-m);">
				...
				<div class="cluster" style="--gap: var(--vs-xs);">
					<span class="chip">Table of Contents</span>
					<span class="chip">Article Layout</span>
					<span class="chip">Related Posts</span>
		...
		<article class="card">
			<div class="card-body stack" style="--gap: var(--vs-m);">
				...
				<div class="cluster" style="--gap: var(--vs-xs);">
					<span class="chip">Sidebar Nav</span>
					<span class="chip">Profile Forms</span>
					<span class="chip">Toggles</span>
